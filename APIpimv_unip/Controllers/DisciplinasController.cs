...
namespace APIpimv_unip.Controllers
{
    ...
    public class DisciplinasController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult<DisciplinaResource>> PostAsync([FromBody] SaveDisciplinaResource resource)
        {
        ...
        // more details see https://aka.ms/RazorPagesCRUD.
        [HttpPut("{id}")]
        public async Task<ActionResult<DisciplinaResource>> PutAsync(int id, [FromBody] SaveDisciplinaResource resource)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState.GetErrorMessages());
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<DisciplinaResource>> DeleteAsync(int id)
        {
